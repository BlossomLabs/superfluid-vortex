...
const BLOCK_EXPLORERS = {
  etherscan: _ref => {
    ...
    const subdomain = providerTypes.ETHERSCAN_NETWORK_TYPES.get(networkType);
    const typePart = providerTypes.ETHERSCAN_TYPES.get(type);
  ...
  blockscout: _ref2 => {
    ...
    const networkName = providerTypes.BLOCKSCOUT_NETWORK_TYPES.get(networkType);
    const typePart = providerTypes.BLOCKSCOUT_TYPES.get(type);
  ...
  polygonscan: _ref3 => {
    ...
    const subdomain = providerTypes.POLYGONSCAN_NETWORK_TYPES.get(networkType);
    const typePart = providerTypes.POLYGONSCAN_TYPES.get(type);
  ...
  arbiscan: _ref4 => {
    ...
    const subdomain = providerTypes.ARBISCAN_NETWORK_TYPES.get(networkType);
    const typePart = providerTypes.ARBISCAN_TYPES.get(type);
