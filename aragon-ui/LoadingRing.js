...
const LoadingRing = /*#__PURE__*/React__default["default"].memo(function LoadingRing(_ref) {
  let {
    paused,
    mode: modeProp,
    ...props
  ...
  const [insideFloatIndicator] = useInside_esm.useInside('FloatIndicator');
