...
class Redraw extends React__default.PureComponent {
  constructor() {
    super(...arguments);
...
const hocWrap = (Component, interval) => {
  const HOC = props => /*#__PURE__*/React__default.createElement(Redraw, {
    interval: interval
  }, () => /*#__PURE__*/React__default.createElement(Component, props));

  HOC.displayName = `Redraw(${_default(Component)})`;
  return HOC;
};
