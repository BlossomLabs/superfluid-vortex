...
const ViewportContext = /*#__PURE__*/React__default.createContext(WINDOW_SIZE_BASE);
...
class ViewportProvider extends React__default.Component {
  constructor() {
    super(...arguments);
...
const Viewport = props => /*#__PURE__*/React__default.createElement(ViewportContext.Consumer, props);

Viewport.Provider = ViewportProvider;
const useViewport = () => React__default.useContext(ViewportContext);
