...
import { useInside, Inside } from '../../../node_modules/use-inside/dist/use-inside.esm.js';
...
function Button(_ref) {
  ...
  const [insideHeaderSecondary] = useInside('Header:secondary'); // Always wide + strong when used as an empty state card action
  ...
  return /*#__PURE__*/React__default.createElement(_StyledButtonBase, _extends({
    ...
    name: "Button",
    data: insideData
  }, children || /*#__PURE__*/React__default.createElement(React__default.Fragment, null, displayIcon && /*#__PURE__*/React__default.createElement(Inside, {
    name: "Button:icon",
    data: insideData
  }, /*#__PURE__*/React__default.createElement(_StyledSpan, {
    $_css13: iconColor,
    $_css14: middleSpace
  }, icon)), displayLabel && /*#__PURE__*/React__default.createElement(Inside, {
    name: "Button:label",
    data: insideData
  }, label))));
}
...
const ButtonWithRef = /*#__PURE__*/React__default.forwardRef((props, ref) => /*#__PURE__*/React__default.createElement(Button, _extends({
  innerRef: ref
}, props)));
ButtonWithRef.Anchor = /*#__PURE__*/React__default.forwardRef((props, ref) => {
...
})(["position:relative;display:flex;color:", ";margin-right:", ";"], p => p.$_css13, p => p.$_css14);
