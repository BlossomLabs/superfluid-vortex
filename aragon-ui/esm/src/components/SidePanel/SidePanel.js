...
import React__default, { useCallback, useState, useEffect, useContext, useRef } from 'react';
...
function SidePanel(_ref2) {
  ...
  const handleTransitionFrame = useCallback((item, _, _ref3) => {
    let {
      progress
    } = _ref3;
  ...
  return /*#__PURE__*/React__default.createElement(RootPortal, null, /*#__PURE__*/React__default.createElement(Inside, {
    name: "SidePanel"
    ...
    return show && /*#__PURE__*/React__default.createElement(_StyledDiv, {
      ...
      $_css8: !compact ? `
                            ...
                            ` : `
                              ...
                              width: ${8 * GU}px;
                            `
    }, /*#__PURE__*/React__default.createElement(IconCross, {
...
const Panel = /*#__PURE__*/React__default.memo(function Panel(_ref5) {
  ...
  const theme = useTheme();
  return /*#__PURE__*/React__default.createElement(_StyledAnimatedAside, _extends({}, props, {
    $_css9: theme.surface,
...
var _StyledAnimatedAside = _styled(animated.aside).withConfig({
