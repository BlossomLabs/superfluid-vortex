...
function DateRangePicker(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(Labels, _extends({
    ref: labelsRef,
    enabled: showPicker,
    ...
    $_css5: theme.border,
    $_css6: theme.surface
  }, /*#__PURE__*/React__default.createElement(_StyledDiv2, null, /*#__PURE__*/React__default.createElement(DatePicker, {
    ...
    $_css9: compactMode ? '' : `
                    ...
                    margin-left: auto;
                  `
  }, /*#__PURE__*/React__default.createElement(ButtonWithRef, {
    onClick: handleClear,
    size: "small",
    wide: true
...
})(["padding:", "px ", "px ", "px;border:1px solid ", ";border-radius:", "px;background:", ";"], p => p.$_css2, p => p.$_css3, p => p.$_css4, p => p.$_css5, BIG_RADIUS, p => p.$_css6);
