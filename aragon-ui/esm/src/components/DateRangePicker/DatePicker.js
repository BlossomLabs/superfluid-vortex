...
function DatePicker(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(_StyledDiv, props, !hideYearSelector && /*#__PURE__*/React__default.createElement(Selector, {
    prev: setDate({
      year: true,
      add: false
    }),
    ...
    small: true
  }, selectedDayjs.format(yearFormat)), !hideMonthSelector && /*#__PURE__*/React__default.createElement(Selector, {
    prev: setDate({
      year: false,
      add: false
    }),
    ...
    return /*#__PURE__*/React__default.createElement(WrappedMonthDay, {
      key: dayJs.format('dd'),
      weekDay: true
