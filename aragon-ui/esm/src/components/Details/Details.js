...
function Details(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(Spring, {
    ...
    }, /*#__PURE__*/React__default.createElement(_StyledDiv2, null))), /*#__PURE__*/React__default.createElement(_StyledH, _extends({}, props, {
      $_css5: 5 * GU,
      $_css6: 3 * GU,
      $_css7: theme.surfaceContentSecondary,
      $_css8: textStyle('label2')
    }), /*#__PURE__*/React__default.createElement(_StyledDiv3, null, label), /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(animated.div, {
      style: {
        marginLeft: `${1 * GU}px`,
        transform: openProgress.to(v => `rotate(${(1 - v) * 180}deg)`),
        transformOrigin: '50% calc(50% - 0.5px)'
      }
    }, /*#__PURE__*/React__default.createElement(_StyledDiv4, null, /*#__PURE__*/React__default.createElement(IconDown, {
      size: "tiny"
