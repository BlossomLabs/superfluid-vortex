...
import React__default, { useRef, useImperativeHandle, useCallback } from 'react';
...
const TextCopy = /*#__PURE__*/React__default.memo( /*#__PURE__*/React__default.forwardRef(function TextCopy(_ref, ref) {
  ...
  return /*#__PURE__*/React__default.createElement(_StyledDiv, _extends({}, props, {
    ...
    }, /*#__PURE__*/React__default.createElement(IconCopy, null)),
...
})(["text-overflow:ellipsis;height:", "px;max-width:100%;border:1px solid ", ";border-radius:", "px;", ";", ";&:read-only{color:", ";text-shadow:none;}"], HEIGHT, p => p.$_css10, RADIUS, p => p.$_css11, p => p.$_css12, p => p.$_css13);
