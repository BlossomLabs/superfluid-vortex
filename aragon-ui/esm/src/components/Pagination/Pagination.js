...
const Pagination = /*#__PURE__*/React__default.memo(function Pagination(_ref) {
  let {
    pages,
    selected,
    onChange,
  ...
  return /*#__PURE__*/React__default.createElement(_StyledDiv, _extends({}, props, {
    $_css: 2 * GU,
    $_css2: 1 * GU
  }), items.map((pageIndex, i) => pageIndex === -1 ? /*#__PURE__*/React__default.createElement(PaginationSeparator, {
    key: `separator-${i}`
  }) : /*#__PURE__*/React__default.createElement(PaginationItem, {
    key: pageIndex,
    index: pageIndex,
