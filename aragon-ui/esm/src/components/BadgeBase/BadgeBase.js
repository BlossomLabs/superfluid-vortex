...
const BadgeBase = /*#__PURE__*/React__default.memo(function BadgeBase(_ref) {
  let {
    badgeRef,
    children,
    className,
...
})(["display:inline-flex;overflow:hidden;color:", ";height:", "px;background:", ";", ";&:active{", ";}border-radius:", "px;"], p => p.$_css, p => p.$_css2, p => p.$_css3, p => p.$_css4, p => p.$_css5, RADIUS);
