...
import memoize from '../../../node_modules/lodash.memoize/index.js';
...
class Timer extends React__default.Component {
  constructor() {
    super(...arguments);
    ...
    _defineProperty(this, "renderTime", () => {
      ...
      return /*#__PURE__*/React__default.createElement("span", null, units.map((unit, index) => {
  ...
  render() {
    ...
    })), /*#__PURE__*/React__default.createElement(Redraw, {
...
var Timer$1 = (props => {
  ...
  return /*#__PURE__*/React__default.createElement(Timer, _extends({}, props, {
    theme: theme
  }));
});
