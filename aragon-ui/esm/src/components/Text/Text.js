...
function Text(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(_StyledSpan, _extends({}, props, {
    $_css: font({
...
const Block = props => /*#__PURE__*/React__default.createElement(Text, _extends({
  as: "div"
}, props));

const Paragraph = props => /*#__PURE__*/React__default.createElement(Text, _extends({
  as: "p"
}, props));
