...
import _default from '../../../node_modules/react-blockies/dist/main.js';
...
class EthIdenticon extends React__default.Component {
  render() {
    const {
      address,
      scale,
    ...
    return isAddress(address) ? /*#__PURE__*/React__default.createElement(Main, _extends({
      size: BLOCKIES_SQUARES * blockiesScale,
      radius: radius
    }, stylingProps(this)), /*#__PURE__*/React__default.createElement(BlockiesScaling, {
