...
class PopoverBase extends React__default.Component {
  constructor() {
    super(...arguments);

    _defineProperty(this, "_cardElement", /*#__PURE__*/React__default.createRef());

    _defineProperty(this, "_popperElement", /*#__PURE__*/React__default.createRef());

    _defineProperty(this, "_document", null);

    _defineProperty(this, "_popper", null);

    _defineProperty(this, "handleEscape", _ref => {
      let {
        keyCode
      } = _ref;
  ...
  render() {
    ...
    }, /*#__PURE__*/React__default.createElement(_StyledAnimatedDiv2, _extends({
      tabIndex: "0",
...
function Popover(_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement(RootPortal, null, /*#__PURE__*/React__default.createElement(Transition, {
    ...
    native: true
  }, (transitionStyles, visible) => visible && /*#__PURE__*/React__default.createElement(PopoverBase, _extends({}, props, {
    rootBoundary: root,
    theme: theme,
...
})(["background:", ";border:1px solid ", ";border-radius:", "px;filter:drop-shadow(0 4px 4px rgba(0,0,0,0.15));&:focus{outline:0;}overflow-y:auto;"], p => p.$_css, p => p.$_css2, BIG_RADIUS);
