...
const TextInput = /*#__PURE__*/React__default.forwardRef((_ref, ref) => {
  let {
    autofocus,
    multiline,
    type,
  ...
  return /*#__PURE__*/React__default.createElement(_StyledInput, _extends({
    ref: handleRef,
...
const WrapperTextInput = /*#__PURE__*/React__default.forwardRef((_ref2, ref) => {
  let {
    adornment,
    adornmentPosition,
    adornmentSettings: {
  ...
  }, /*#__PURE__*/React__default.createElement(_StyledTextInput, _extends({
    ref: ref
  }, props, {
...
}, p => p.$_css, p => p.$_css2, p => p.$_css3, p => p.$_css4, p => p.$_css5, MEDIUM_RADIUS, p => p.$_css6, p => p.$_css7, p => p.$_css8, p => p.$_css9, p => p.$_css10, p => p.$_css11);
