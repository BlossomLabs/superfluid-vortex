...
const ThemeContext = /*#__PURE__*/React__default.createContext(prepareTheme(getTheme(THEME_DEFAULT)));
...
function prepareTheme(theme) {
  const themeConverted = Object.fromEntries(Object.entries(theme).filter(_ref => {
    let [name] = _ref;
