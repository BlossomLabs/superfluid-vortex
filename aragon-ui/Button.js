...
function Button(_ref) {
  ...
  const [insideEmptyStateCard] = useInside_esm.useInside('EmptyStateCard');
  const [insideHeaderSecondary] = useInside_esm.useInside('Header:secondary'); // Always wide + strong when used as an empty state card action
  ...
  return /*#__PURE__*/React__default["default"].createElement(_StyledButtonBase, _extends._extends({
    ...
    name: "Button",
    data: insideData
  }, children || /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, displayIcon && /*#__PURE__*/React__default["default"].createElement(useInside_esm.Inside, {
    name: "Button:icon",
    data: insideData
  }, /*#__PURE__*/React__default["default"].createElement(_StyledSpan, {
    $_css13: iconColor,
    $_css14: middleSpace
  }, icon)), displayLabel && /*#__PURE__*/React__default["default"].createElement(useInside_esm.Inside, {
    name: "Button:label",
    data: insideData
  }, label))));
}
