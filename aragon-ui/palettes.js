...
const resolveColors = (palette, palettes) => Object.entries(palette).reduce((pal, _ref) => {
  let [name, value] = _ref;
...
const generateGroups = palettes => Object.entries(palettes).reduce((groups, _ref2) => {
  let [paletteName, palette] = _ref2;
...
const {
  ...
  brand,
  colors
} = Object.fromEntries(Object.entries(generateGroups(aragon["default"])).map(_ref3 => {
  let [name, group] = _ref3;
