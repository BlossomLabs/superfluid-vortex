...
var math = require('./math-23d64dd2.js');
...
function CircleGraph(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(reactSpringWeb_esm.Spring, {
    ...
    })), /*#__PURE__*/React__default["default"].createElement(_StyledDiv2, null, typeof label !== 'function' ? label : label && /*#__PURE__*/React__default["default"].createElement(_StyledDiv3, null, /*#__PURE__*/React__default["default"].createElement(_StyledDiv4, null, /*#__PURE__*/React__default["default"].createElement(reactSpringWeb_esm.animated.div, {
      style: {
        fontSize: `${size * 0.2}px`
      }
    }, progressValue.to(labelPart('prefix'))), /*#__PURE__*/React__default["default"].createElement(reactSpringWeb_esm.animated.div, {
      style: {
        fontSize: `${size * 0.25}px`
      }
    }, progressValue.to(labelPart('value'))), /*#__PURE__*/React__default["default"].createElement(_StyledAnimatedDiv, {
      style: {
        fontSize: `${size * 0.13}px`
      },
      $_css3: theme.surfaceContentSecondary
    }, progressValue.to(labelPart('suffix')))), /*#__PURE__*/React__default["default"].createElement(_StyledAnimatedDiv2, {
      style: {
...
var _StyledAnimatedCircle = _styled__default["default"](reactSpringWeb_esm.animated.circle).withConfig({
